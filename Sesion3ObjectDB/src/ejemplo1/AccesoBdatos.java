...
public class AccesoBdatos {
	...
	public void consulta1() {
		...
		TypedQuery<EmpleadoEntity> q1 = em.createQuery("SELECT e FROM EmpleadoEntity e", EmpleadoEntity.class); 
		List<EmpleadoEntity> lista = q1.getResultList(); 
	...
	public void consulta2() {
		...
		TypedQuery<EmpleadoEntity> q1 = em.createQuery("SELECT e FROM EmpleadoEntity e WHERE nombre LIKE :nombre", EmpleadoEntity.class); 
		q1.setParameter("nombre", '%' + "Carrera" + '%');
		List<EmpleadoEntity> lista = q1.getResultList(); 
	...
	public void consulta3() {
		...
		TypedQuery<EmpleadoEntity> q1 = em.createQuery("SELECT e FROM EmpleadoEntity e WHERE departamento.nombre LIKE :departamento AND oficio LIKE :oficio", EmpleadoEntity.class); 
		q1.setParameter("departamento", "I+D");
		q1.setParameter("oficio", "Empleado"); 
		List<EmpleadoEntity> lista = q1.getResultList(); 
	...
	public void consulta4() {
		...
		TypedQuery<EmpleadoEntity> q1 = em.createQuery("SELECT e FROM EmpleadoEntity e WHERE YEAR(e.alta) >= :fechaAlta", EmpleadoEntity.class); 
		q1.setParameter("fechaAlta",2003);
		List<EmpleadoEntity> lista = q1.getResultList(); 
	...
	public void consulta5() {
		...
		TypedQuery<EmpleadoEntity> q1 = em.createQuery("SELECT e FROM EmpleadoEntity e ORDER BY departamento.nombre ", EmpleadoEntity.class); 
		List<EmpleadoEntity> lista = q1.getResultList(); 
		
		for (EmpleadoEntity empleado : lista) {
			
			System.out.println(empleado.getDepartamento().getNombre() + " - " + empleado.getNombre());
